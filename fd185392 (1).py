...
def _wait_for_kac_ready(namespace, timeout_s=120):
    ...
    while time.time() < deadline:
        ...
        time.sleep(10)
    print(f"  [WARN] KAC deployment not ready after {timeout_s}s — metrics may be incomplete.")
